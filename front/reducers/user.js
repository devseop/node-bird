...
export const initialState = {
  loadMyInfoLoading: false, // 내 정보 불러오기 시도 중
  loadMyInfoDone: false,
  loadMyInfoError: null,
  loadUserInfoLoading: false, // 사용자 정보 불러오기 시도 중
  ...
  produce(state, (draft) => {
    switch (action.type) {
      ...
      case REMOVE_FOLLOWER_SUCCESS:
        ...
        draft.myInfo.Followers = draft.myInfo.Followers.filter(
          (v) => v.id !== action.data.UserId
        );
        break;
      ...
      //   myInfo: {
      //     ...state.myInfo,
      //     Posts: [{ id: action.data }, ...state.myInfo.Posts],
      //   },
      // };
      ...
      //   myInfo: {
      //     ...state.myInfo,
      //     Posts: state.myInfo.Posts.filter((v) => v.id !== action.data),
      //   },
      // };
      default:
        break;
